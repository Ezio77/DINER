...
from dataio import ImageData,oneDimData,ImageData_3d
...
def train_img(opt):
    ...
    model_input,gt = ImageData_3d(image_path = img_path,
        ...
        try:
            ...
            for i in range(1,31):
                ...
                for j in range(2,8):
                    ...
                    log[i-1,j-2] = train_img(opt)
                    pbar.update(1)

        except:
            utils.save_data(log,'experiment_results/7d/psnr.mat')
